  ...
  def emailit
    ...
    if self.group_id.to_i > 0
      ...
      if group and group.is_global
        # Only send Global Townhall Square messages if they're from a moderator
